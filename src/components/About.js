...
const About = () => {
    ...
    return (
        <section>
            ...
            <div className="about_img1" data-aos="fade-down" data-aos-duration="3000">
                ...
                <div className="about_img3" data-aos="fade-down" data-aos-duration="3000">
                    <img src={oluseun3} alt="image2" />
                </div>
            </section>
            <section className="about_container">
            ...
            <section className="about_container">
            <div className="about_img2" data-aos="fade-down" data-aos-duration="3000">
                ...
                <div className="about_img4" data-aos="fade-down" data-aos-duration="3000">
                    <img src={oluseun2} alt="image3" />
                </div>
            </section>
            <section className="about_container">
